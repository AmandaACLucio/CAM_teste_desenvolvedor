...
class Funcionario(models.Model):
    ...
    def __str__(self):
        return str({"Nome": self.Nome, "CPF": self.CPF, "RG": self.RG, "Sexo": self.Sexo, "Data_nascimento": self.Data_nascimento, "Possui_habilitacao": self.Possui_habilitacao, "Salario": self.Salario, "Carga_horaria": self.Carga_horaria})
